...
This license fills the gaps between the terms that open software developers apply to their work and the terms that companies expect for software they rely on. Open software developers can sell supplementary licenses to companies on these terms to fill those gaps.
