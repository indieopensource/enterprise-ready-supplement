...
1.  Legal "work made for hire" rules can make employers and clients, rather than developers, owners of intellectual property in software developers create

2.  Common legal agreements, such as independent contractor, employee, and company founder contracts, transfer ownership of intellectual property to others.
...
_Developer_ guarantees that any _Software Dependencies_ are _Open Software_ and generally available for _Company_ to download, free of charge, from a _Public Software Repository_. _Developer_ does not agree to any service-level agreement or other specific guarantee about any _Public Software Repository_.
...
Subject to [Damages Limit Exceptions](#Damages_Limit_Exceptions), _Developer_'s total liability for breach of this agreement will not exceed the amount _Company_ paid _Developer_ under this agreement during the twelve months before the first claim is filed. This limit applies even if _Developer_ is advised that _Company_ may suffer damages, and even if _Company_ paid nothing at all.
